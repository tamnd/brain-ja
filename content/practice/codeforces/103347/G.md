...
[CF 103347G - オフィーリアの花](https://codeforces.com/problemset/problem/103347/G)
...
最初の解決策は、各コンポーネントを実行可能な最小値で選択することによって得られます。$T_s = t$:$$r_j = L_j \quad (s \ge j \ge 0).$$### アルゴリズム B (境界のある構成)
