---
title: "CF 103660H - 距離"
description: "$G$ を生成子 $(alpha1,dots,alphak)$ を持つ対称群 $Sn$ のケーリー グラフとし、各生成子が {1,dots,n}$ 内の固定個別シンボル $x,y に対して $$alphaj(x)=y$$ を満たすと仮定します。"
...
[CF 103660H - 距離](https://codeforces.com/problemset/problem/103660/H)
