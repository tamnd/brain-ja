...
[CF 103109G - 落書き道路](https://codeforces.com/problemset/problem/103109/G)
 ...
 **確認済み:** いいえ
 ...
 本当に$x \ge t-1$、一般化二項係数を定義します。$$\binom{x}{t} = \frac{x(x-1)\cdots(x-t+1)}{t!}, \qquad 
