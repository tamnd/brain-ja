...
[CF 104049K - 鋼の錬金術師 II](https://codeforces.com/problemset/problem/104049/K)
...
A node with variable index$k$ただし、1 つのオペランドが欠落している場合は、そのオペランドを両方のブランチで複製することによって処理されます。 
...
最後に、ノードの共有と冗長なテストの排除によって、すべての結果が削減されます。 
